...
def user_vid_path(instance, filename):
    ...
    return f"@{instance.creator.username}/activity/{instance.uuid}.{ext}"

def user_sound_path(instance, filename):
    ext = filename.split(".")[-1]
    return f"@{instance.creator.username}/sound/{instance.original_activity.uuid}.{ext}"
                    ...
                    <div style="width:100%;max-width: 440px; padding: 0 20px;">
                        <div style="width: 100%; padding: 40px 7px;">
                            <img style="width: 35px;"
                                src="https://i.ibb.co/GVYGFCF/vita-icon.png"
                                style="margin: 40px 12px 40px 12px; width: 35px; height: 40px;">
                            <img style="width: 150px;"
                                src="https://i.ibb.co/N6D8RGC/vita-text.png"
                        ...
                        style="max-width:100%;background-color: #f8f8f8; padding: 24px 16px;font-size: 17px;color: rgba(22,24, 35, 0.75);line-height: 20px;">
                            <p style="margin-bottom:20px;">To verify your account, enter this code in VitaDating:</p>
                            ...
                            <p>VitaDating Support Team</p>
                            <p style="word-break: break-all;">
                                VitaDating Help Center: <br>
                        ...
                        <div style="border: 0; background-color: rgba(0, 0, 0, 0.12); height: 1px;margin-bottom:16px;"></div>
                            ...
                            <div>VitaDating, 42 North Vibe Avenue Cloud 9, Andromeda Galaxy 424242</div>
                        </div>
                        </div>
                    </div>
                </body>
