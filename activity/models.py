...
from VitaDating.helpers import user_vid_path, gen_uuid, user_sound_path
...
class Activity(models.Model):
    ...
    sound = models.ForeignKey("activity.Sound", related_name="vid_sound", on_delete=models.CASCADE, null=True, blank=True,)
...
class Sound(models.Model):
    creator = models.ForeignKey("vitaDatinguser.vitaDatinguser", related_name="sound_creator", on_delete=models.CASCADE)
    original_activity = models.ForeignKey("activity.activity", related_name="og_sound", on_delete=models.CASCADE)
...
class Comment(models.Model):
    user = models.ForeignKey('vitaDatinguser.vitaDatinguser', null=True, blank=True, on_delete=models.CASCADE, related_name="commenter")
    comment = models.CharField(max_length=60, null=True, blank=True)
    likes = models.IntegerField(default=0)
    liked_by = models.ManyToManyField('vitaDatinguser.vitaDatinguser', blank=True, related_name="like_list")
